    ...
    <main>
        <div class="container-fluid px-4">
            <ol class="row g-2 mr-0 pl-3 justify-content-between">
                ...
                <div class="mt-2 mr-1">
                    <a href="<?= base_url('resepsionis/jadwal_dokter') ?>" class="btn btn-light ms-auto me-3 me-lg-4 p-1" data-bs-toggle="modal">
            ...
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a href="<?= base_url('resepsionis/jadwal_dokter') ?>"><?= $templateAtas ?></a></li>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="<?= site_url('admin/update_jadwal/' . $jadwal['id']) ?>" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="_method" value="PUT">    
                    <?= csrf_field() ?>

                        <div class="mb-3">
                            <label for="hari" class="form-label">Hari : <small style="color: red;">*</small></label>
                            <input type="text" id="hari" name="hari" class="form-control" value="<?= $jadwal['hari'] ?>">
                        </div>

                        <div class="mb-3">
                            <label for="tanggal" class="form-label">Tanggal Praktek :</label>
                            <input type="text" id="tanggal" name="tanggal" class="form-control" value="<?= $jadwal['tanggal'] ?>">
                        </div>

                        <div class="mb-3">
                            <label for="jam_mulai" class="form-label">Jam Mulai :<small style="color: red;">*</small></label>
                            <input type="text" id="jam_mulai" name="jam_mulai" class="form-control" value="<?= $jadwal['jam_mulai'] ?>">
                        </div>

                        <div class="mb-3">
                            <label for="jam_selesai" class="form-label">Jam Selesai :</label>
                            <input type="text" id="jam_selesai" name="jam_selesai" class="form-control" value="<?= $jadwal['jam_selesai'] ?>">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <?php foreach ($poli as $poli) : ?>
                                    ...
                                    <?= $poli['id_poli'] == $poli['id_poli'] ? 'selected' :''?>>
                                        <?= $poli['kode_poli'] ?>
                                    </option>
                                    <?php endforeach; ?>
                            </select>
                        ...
                        <div class="modal-footer">
                            <a href="<?= base_url('resepsionis/jadwal_dokter') ?>" type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</a>
