                ...
                <div class="card-body">
                    <form action="<?= site_url('resepsionis/update/' . $user['id']) ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="spesialis" name="spesialis" class="form-control" value="<?= $user['spesialis'] ?>">
                        </div>

                        <div class="mb-3">
                            <label for="no_tlp" class="form-label">Nomor Telepon:</label>
                            <input type="text" id="no_tlp" name="no_tlp" class="form-control" value="<?= $user['no_tlp'] ?>">
                        </div>
