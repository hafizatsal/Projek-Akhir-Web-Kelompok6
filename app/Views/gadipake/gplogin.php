                        ...
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="POST" action="<?php echo site_url ("puskesmas/login")?>">
                                        <!-- Replace 'your_login_controller' and 'login_method' with your actual controller and method names -->
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="inputUsername" type="text" placeholder="username" 
                                            value="<?php if($session->getFlashdata('username')) 
