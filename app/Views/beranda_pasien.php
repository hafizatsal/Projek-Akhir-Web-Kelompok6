...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s">
        <a href="home_pasien" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h1 class="m-0 text-primary"><i class="far fa-hospital me-3"></i>Puskesmas</h1>
        </a>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu rounded-0 rounded-bottom m-0">
                        ...
                        <a href="/home_pasien/daftar" class="dropdown-item">Daftar Online</a>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-4">
                        <div class="border-start border-light ps-4">
                            ...
                            <p class="text-light mb-0">Peralatan Medis</p>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="border-start border-light ps-4">
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <h1 class="mb-4">Kenapa kamu harus percaya terhadap kami, ketahui tentang kami!</h1>
                    <p>Karena kami selalu siap dan ramah</p>
                    <p class="mb-4">Jangan ragu terhadap kami</p>
            ...
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 feature-text py-5 wow fadeIn" data-wow-delay="0.1s">
                    <div class="p-lg-5 ps-lg-0">
                        ...
                        <p class="text-white mb-4 pb-2">Kami yang terbaik</p>
                        <div class="row g-4">
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ms-4">
                                        <p class="text-white mb-2">Positif</p>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <p class="d-inline-block border rounded-pill py-1 px-4">Daftar Online</p>
                    <h1 class="mb-4">Buat temu janji dengan dokter secara online</h1>
                    <p class="mb-4">memudahkan tanpa perlu mengantri</p>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="bg-light rounded h-100 d-flex align-items-center p-5">
                        <form>
                        <div class="col-12">
                                    <a href="/home_pasien/daftar" class="btn btn-primary w-100 py-3">Daftar Online</a>
                                </div>
                            </div>
                        </form>
                    </div>
